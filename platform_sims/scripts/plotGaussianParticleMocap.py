    ...
    while not rospy.is_shutdown():
        ...
        if SpawnUAV1:
            ...
            try:
                for xCurrentIndex in range(len(xPlumePlot)):
                    for yCurrentIndex in range(len(yPlumePlot)):
                        # print(Robot1_EstimatedGaussian.Theta, Robot1_EstimatedGaussian.X, Robot1_EstimatedGaussian.Y, Robot1_EstimatedGaussian.Z, Robot1_EstimatedGaussian.Q, Robot1_EstimatedGaussian.V, Robot1_EstimatedGaussian.Dy, Robot1_EstimatedGaussian.Dz)
                                                                                                           # getReading(xRobotDef, yRobotDef, thetaFunc, xPlumeFunc, yPlumeFunc, zFunc, QFunc, vFunc, DyFunc, DzFunc)
                        conArray[yCurrentIndex,xCurrentIndex] = getReading(xPlumePlot[xCurrentIndex], yPlumePlot[yCurrentIndex], Robot1_EstimatedGaussian.Theta, Robot1_EstimatedGaussian.X, Robot1_EstimatedGaussian.Y, Robot1_EstimatedGaussian.Z, Robot1_EstimatedGaussian.Q, Robot1_EstimatedGaussian.V, Robot1_EstimatedGaussian.Dy, Robot1_EstimatedGaussian.Dz)
            except:
                pass
