...
int main(int argc, char **argv){
  ...
  ros::Publisher local_att_pub = nh.advertise<mavros_msgs::AttitudeTarget>("mavros/setpoint_raw/attitude",1);
  ...
  mavros_msgs::AttitudeTarget DesiredAtt;
  DesiredAtt.body_rate.x = joyStickValues.axes[3];
  DesiredAtt.body_rate.y = joyStickValues.axes[4];
  DesiredAtt.body_rate.z = joyStickValues.axes[0];
  //map(value, fromLow, fromHigh, toLow, toHigh)
  DesiredAtt.thrust = map(joyStickValues.axes[1],-1,1,0.001,1);
