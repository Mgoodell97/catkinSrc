...
std::vector <std::vector<double> > createWaypointMatrix(double xmin, double xmax, int Nx, double ymin, double ymax, int Ny,double zmin, double zmax, int Nz){
...
int main(int argc, char **argv){
  ...
  ros::param::get("zScanNoYaw/xmin", xmin);
  ros::param::get("zScanNoYaw/xmax", xmax);
  ros::param::get("zScanNoYaw/Nx", Nx);
  ros::param::get("zScanNoYaw/ymin", ymin);
  ros::param::get("zScanNoYaw/ymax", ymax);
  ros::param::get("zScanNoYaw/Ny", Ny);
  ...
  // createWaypointMatrix(double xmin, double xmax, int Nx, double ymin, double ymax, int Ny,double zmin, double zmax, int Nz)
  std::vector <std::vector<double> > desiredPose = createWaypointMatrix(xmin,xmax,Nx,ymin,ymax,Ny,zmin,zmax,Nz);
  ...
  while(ros::ok()){
    ...
    if (current_state.armed){
      ...
      if(withinWaypoint <= waypointRadius){
        ...
        if(ros::Time::now() - waypointStartTime >= ros::Duration(stayTime)){
